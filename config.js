...
module.exports = {
  ...
  author:  process.env.PACK_INFO.split(";")[0] === undefined ? 'ᴍͥ ʀ  ɪ ꜱͣ ᴜͫ ʀ ᴜ  x' : process.env.PACK_INFO.split(";")[0],
  ...
  alwaysonline:  process.env.ALWAYS_ONLINE === undefined ? truee : process.env.ALWAYS_ONLINE,
  ...
  BRANCH: 'main', 
  ALIVE_MESSAGE:  process.env.ALIVE_MESSAGE === undefined ? '```IAM ALIVE NOW !```' : process.env.ALIVE_MESSAGE,
